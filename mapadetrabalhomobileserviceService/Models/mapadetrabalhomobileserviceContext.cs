...
namespace mapadetrabalhomobileserviceService.Models
{
    public class mapadetrabalhomobileserviceContext : DbContext
    {
        ...
        public mapadetrabalhomobileserviceContext() : base(connectionStringName)
        {
        } 
